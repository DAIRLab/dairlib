...
def plot_osc_debug(t_u, fsm, osc_debug):
  ...
  plt.plot(osc_debug["r_foot_traj"].t, osc_debug["r_foot_traj"].y_des[:, 2])
  plt.plot(osc_debug["r_foot_traj"].t, osc_debug["r_foot_traj"].y[:, 2])
  plt.plot(osc_debug["r_foot_traj"].t, osc_debug["r_foot_traj"].error_y[:, 2])
