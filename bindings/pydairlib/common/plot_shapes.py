...
TODO:
  There is a fair amount of code duplication here;
  a superclass may be warranted.
...
class Face():
    ...
    def __init__(self, ax, corners, *,
        ...
        self.polyc = art3d.Poly3DCollection(
            self.verts, linewidth=linewidth, antialiased=antialiased,
            alpha=alpha, edgecolors=edgecolors, facecolors=self.facecolors)
