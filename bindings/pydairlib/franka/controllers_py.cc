...
PYBIND11_MODULE(controllers, m) {
  ...
  py::class_<C3Options>(m, "C3Options")
      ...
      .def_readwrite("world_x_limits", &C3Options::world_x_limits)
      .def_readwrite("world_y_limits", &C3Options::world_y_limits)
      .def_readwrite("world_z_limits", &C3Options::world_z_limits)
