...
from pydairlib.perceptive_locomotion.perception_learning.stable_baselines3.common.preprocessing import get_action_dim
...
class StateDependentNoiseDistribution(Distribution):
    ...
    def get_noise(self, latent_sde: th.Tensor) -> th.Tensor:
        ...
        if len(latent_sde) == 1 or len(latent_sde) != len(self.exploration_matrices):
            #print(self.exploration_mat.get_device())
            exploration_mat = self.exploration_mat.to(latent_sde.device)
