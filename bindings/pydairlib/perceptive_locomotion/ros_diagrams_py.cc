...
PYBIND11_MODULE(ros_diagrams, m) {
  ...
  py::class_<CassieElevationMappingRosDiagram, drake::systems::Diagram<double>>(
      ...
      .def("lcm", &CassieElevationMappingRosDiagram::lcm,
           py_rvp::reference_internal)
      .def("plant", &CassieElevationMappingRosDiagram::plant,
           py_rvp::reference_internal)
      .def("get_input_port_state",
           &CassieElevationMappingRosDiagram::get_input_port_state,
           py_rvp::reference_internal)
      .def("get_input_port_contact",
           &CassieElevationMappingRosDiagram::get_input_port_contact,
           py_rvp::reference_internal)
      .def("get_output_port_state",
           &CassieElevationMappingRosDiagram::get_output_port_state,
           py_rvp::reference_internal)
       .def("get_output_port_grid_map",
           &CassieElevationMappingRosDiagram::get_output_port_grid_map,
           py_rvp::reference_internal);
