...
std::pair<VectorXd, VectorXd> GetInitialCassieState(
  ...
  program.AddBoundingBoxConstraint(0, 0, q(positions_map.at("pelvis_x")));
  program.AddBoundingBoxConstraint(0, 0, q(positions_map.at("pelvis_y")));
  program.AddBoundingBoxConstraint(height, height, q(positions_map.at("pelvis_z")));
  program.AddBoundingBoxConstraint(-10, 10, v);
  program.AddBoundingBoxConstraint(0, 0, v(vel_map.at("pelvis_wx")));
  program.AddBoundingBoxConstraint(0, 0, v(vel_map.at("pelvis_wy")));
  program.AddBoundingBoxConstraint(0, 0, v(vel_map.at("pelvis_wz")));

  program.AddBoundingBoxConstraint(pelvis_vel(0), pelvis_vel(0), v(vel_map.at("pelvis_vx")));
  program.AddBoundingBoxConstraint(pelvis_vel(1), pelvis_vel(1), v(vel_map.at("pelvis_vy")));
  program.AddBoundingBoxConstraint(pelvis_vel(2), pelvis_vel(2), v(vel_map.at("pelvis_vz")));
