...
void CassieRbtStateEstimator::CopyStateOut(
  ...
  AssignActuationFeedbackToOutputVector(cassie_out, output);
  AssignNonFloatingBaseStateToOutputVector(cassie_out, output);
  output->SetVelocityAtIndex(12, cassie_state->GetVelocities()[12]);
  output->SetVelocityAtIndex(13, cassie_state->GetVelocities()[13]);
  cout << "CopyStateOut: " << cassie_state->GetVelocities() << endl;
