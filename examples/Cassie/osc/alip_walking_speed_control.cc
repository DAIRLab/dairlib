#include "examples/Cassie/osc/alip_walking_speed_control.h"
...
AlipWalkingSpeedControl::AlipWalkingSpeedControl(
  ...
  this->DeclareVectorOutputPort("foot_xy", BasicVector<double>(2),
                                &AlipWalkingSpeedControl::CalcFootPlacement);
...
void AlipWalkingSpeedControl::CalcFootPlacement(const Context<double>& context,
