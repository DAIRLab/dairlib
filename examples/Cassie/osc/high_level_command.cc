...
void HighLevelCommand::SetDesiredXYTraj(
  ...
  //  0.000, dt=2.000, dx/dt=0.0: {0.000, 0.000},
  //  2.000, dt=5.000, dx/dt=0.2: {0.000, 0.000},
  //  7.000, dt=3.333, dx/dt=0.7: {1.250, 0.000},
  //  10.333, dt=1.250, dx/dt=1.0: {3.750, 0.000},
  //  11.583, dt=0.330, dx/dt=1.0: {5.000, 0.000},
  //  11.914, dt=0.330, dx/dt=1.0: {5.329, 0.027},
  //  12.244, dt=0.330, dx/dt=1.0: {5.649, 0.108},
  //  12.574, dt=0.330, dx/dt=1.0: {5.952, 0.241},
  //  12.905, dt=0.330, dx/dt=1.0: {6.228, 0.422},
  //  13.235, dt=0.330, dx/dt=1.0: {6.471, 0.645},
  //  13.565, dt=0.330, dx/dt=1.0: {6.674, 0.906},
  //  13.896, dt=0.330, dx/dt=1.0: {6.832, 1.197},
  //  14.226, dt=0.330, dx/dt=1.0: {6.939, 1.509},
  //  14.556, dt=0.330, dx/dt=1.0: {6.993, 1.835},
  //  14.887, dt=0.330, dx/dt=1.0: {6.993, 2.165},
  //  15.217, dt=0.330, dx/dt=1.0: {6.939, 2.491},
  //  15.547, dt=0.330, dx/dt=1.0: {6.832, 2.803},
  //  15.877, dt=0.330, dx/dt=1.0: {6.674, 3.094},
  //  16.208, dt=0.330, dx/dt=1.0: {6.471, 3.355},
  //  16.538, dt=0.330, dx/dt=1.0: {6.228, 3.578},
  //  16.868, dt=0.330, dx/dt=1.0: {5.952, 3.759},
  //  17.199, dt=0.330, dx/dt=1.0: {5.649, 3.892},
  //  17.529, dt=0.330, dx/dt=1.0: {5.329, 3.973},
  //  17.859, dt=1.250, dx/dt=1.0: {5.000, 4.000},
  //  19.109, dt=3.333, dx/dt=0.8: {3.750, 4.000},
  //  22.443, dt=5.000, dx/dt=0.2: {1.250, 4.000},
  //  27.443, dt=-1.000, dx/dt=-1.0: {0.000, 4.000}
  /*std::vector<double> breaks = {
  ...
  // Traj:  2023-05-27 15:58:38.245735Straight 2.5 meters -> Straight 2.5 meters
  // #2 -> Turn 180 degrees -> Straight 2.5 meters #3 -> Straight 2.5 meters #4
  /*std::vector<double> breaks = {
      0.000,  2.000,  11.000, 14.333, 15.583, 15.914, 16.244, 16.574, 16.905,
      17.235, 17.565, 17.896, 18.226, 18.556, 18.887, 19.217, 19.547, 19.877,
      20.208, 20.538, 20.868, 21.199, 21.529, 21.859, 23.109, 26.443, 35.443};
  std::vector<std::vector<double>> knots_vec = {
      {0.000, 0.000}, {0.000, 0.000}, {2.250, 0.000}, {4.750, 0.000},
      {6.000, 0.000}, {6.329, 0.027}, {6.649, 0.108}, {6.952, 0.241},
      {7.228, 0.422}, {7.471, 0.645}, {7.674, 0.906}, {7.832, 1.197},
      {7.939, 1.509}, {7.993, 1.835}, {7.993, 2.165}, {7.939, 2.491},
      {7.832, 2.803}, {7.674, 3.094}, {7.471, 3.355}, {7.228, 3.578},
      {6.952, 3.759}, {6.649, 3.892}, {6.329, 3.973}, {6.000, 4.000},
      {4.750, 4.000}, {2.250, 4.000}, {0.000, 4.000}};*/

  // Traj:  2023-05-27 17h34m44s: Straight 2.5 meters -> Straight 2.5 meters #2
  ...
  // 4.000: {1.000, 0.000};   dt=3.333, dx/dt=0.8
  // 7.333: {3.500, 0.000};   dt=2.500, dx/dt=1.0
  // 9.833: {6.000, 0.000};   dt=0.166, dx/dt=1.0
  // 9.999: {6.166, 0.000};   dt=0.331, dx/dt=1.0
  // 10.331: {6.493, 0.055};   dt=0.331, dx/dt=1.0
  // 10.662: {6.806, 0.162};   dt=0.331, dx/dt=1.0
  // 10.993: {7.098, 0.320};   dt=0.331, dx/dt=1.0
  // 11.325: {7.359, 0.524};   dt=0.331, dx/dt=1.0
  // 11.656: {7.584, 0.767};   dt=0.331, dx/dt=1.0
  // 11.988: {7.765, 1.045};   dt=0.331, dx/dt=1.0
  // 12.319: {7.898, 1.348};   dt=0.331, dx/dt=1.0
  // 12.651: {7.979, 1.670};   dt=0.331, dx/dt=1.0
  // 12.982: {8.007, 2.000};   dt=0.331, dx/dt=1.0
  // 13.314: {7.979, 2.330};   dt=0.331, dx/dt=1.0
  // 13.645: {7.898, 2.652};   dt=0.331, dx/dt=1.0
  // 13.976: {7.765, 2.955};   dt=0.331, dx/dt=1.0
  // 14.308: {7.584, 3.233};   dt=0.331, dx/dt=1.0
  // 14.639: {7.359, 3.476};   dt=0.331, dx/dt=1.0
  // 14.971: {7.098, 3.680};   dt=0.331, dx/dt=1.0
  // 15.302: {6.806, 3.838};   dt=0.331, dx/dt=1.0
  // 15.634: {6.493, 3.945};   dt=0.331, dx/dt=1.0
  // 15.965: {6.166, 4.000};   dt=0.166, dx/dt=1.0
  // 16.131: {6.000, 4.000};   dt=2.500, dx/dt=1.0
  // 18.631: {3.500, 4.000};   dt=3.333, dx/dt=0.8
  // 21.964: {1.000, 4.000};   dt=2.000, dx/dt=0.5
  // 21.964: {0.000, 4.000}
  std::vector<double> breaks = {0.000,  2.000,  4.000,  7.333,  9.833,  9.999,
                                10.331, 10.662, 10.993, 11.325, 11.656, 11.988,
                                12.319, 12.651, 12.982, 13.314, 13.645, 13.976,
                                14.308, 14.639, 14.971, 15.302, 15.634, 15.965,
                                16.131, 18.631, 21.964, 23.964};
  std::vector<std::vector<double>> knots_vec = {
...
VectorXd HighLevelCommand::CalcCommandFromDesiredXYTraj(
  ...
  if ((std::abs(local_delta_xy(1)) > 0.1) && !reach_the_end_of_traj) {
    command_yaw_vel += 2 * local_delta_xy(1);
  }
  command_vel << command_yaw_vel, command_xy_vel(0), 0;
