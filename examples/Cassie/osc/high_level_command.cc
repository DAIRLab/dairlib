...
void HighLevelCommand::SetDesiredXYTraj(
  ...
  // Traj:  2023-05-28 12h53m09s: Straight 5.0 meters -> Turn 180 degrees (2.0 m
  ...
  // 9.732: {6.166, 4.000};   dt=0.166, dx/dt=2.0
  // 9.897: {6.493, 3.945};   dt=0.166, dx/dt=2.0
  // 10.063: {6.806, 3.838};   dt=0.166, dx/dt=2.0
  // 10.229: {7.098, 3.680};   dt=0.166, dx/dt=2.0
  // 10.395: {7.359, 3.476};   dt=0.166, dx/dt=2.0
  // 10.560: {7.584, 3.233};   dt=0.166, dx/dt=2.0
  // 10.726: {7.765, 2.955};   dt=0.166, dx/dt=2.0
  // 10.892: {7.898, 2.652};   dt=0.166, dx/dt=2.0
  // 11.057: {7.979, 2.330};   dt=0.166, dx/dt=2.0
  // 11.223: {8.007, 2.000};   dt=0.166, dx/dt=2.0
  // 11.389: {7.979, 1.670};   dt=0.166, dx/dt=2.0
  // 11.555: {7.898, 1.348};   dt=0.166, dx/dt=2.0
  // 11.720: {7.765, 1.045};   dt=0.166, dx/dt=2.0
  // 11.886: {7.584, 0.767};   dt=0.166, dx/dt=2.0
  // 12.052: {7.359, 0.524};   dt=0.166, dx/dt=2.0
  // 12.218: {7.098, 0.320};   dt=0.166, dx/dt=2.0
  // 12.383: {6.806, 0.162};   dt=0.166, dx/dt=2.0
  // 12.549: {6.493, 0.055};   dt=0.166, dx/dt=2.0
  // 12.715: {6.166, 0.000};   dt=0.083, dx/dt=2.0
  // 12.798: {6.000, 0.000};   dt=0.083, dx/dt=2.0
  // 12.880: {6.166, 0.000};   dt=0.166, dx/dt=2.0
  // 13.046: {6.493, 0.055};   dt=0.166, dx/dt=2.0
  // 13.212: {6.806, 0.162};   dt=0.166, dx/dt=2.0
  // 13.378: {7.098, 0.320};   dt=0.166, dx/dt=2.0
  // 13.543: {7.359, 0.524};   dt=0.166, dx/dt=2.0
  // 13.709: {7.584, 0.767};   dt=0.166, dx/dt=2.0
  // 13.875: {7.765, 1.045};   dt=0.166, dx/dt=2.0
  // 14.040: {7.898, 1.348};   dt=0.166, dx/dt=2.0
  // 14.206: {7.979, 1.670};   dt=0.166, dx/dt=2.0
  // 14.372: {8.007, 2.000};   dt=0.166, dx/dt=2.0
  // 14.538: {7.979, 2.330};   dt=0.166, dx/dt=2.0
  // 14.703: {7.898, 2.652};   dt=0.166, dx/dt=2.0
  // 14.869: {7.765, 2.955};   dt=0.166, dx/dt=2.0
  // 15.035: {7.584, 3.233};   dt=0.166, dx/dt=2.0
  // 15.201: {7.359, 3.476};   dt=0.166, dx/dt=2.0
  // 15.366: {7.098, 3.680};   dt=0.166, dx/dt=2.0
  // 15.532: {6.806, 3.838};   dt=0.166, dx/dt=2.0
  // 15.698: {6.493, 3.945};   dt=0.166, dx/dt=2.0
  // 15.863: {6.166, 4.000};   dt=0.083, dx/dt=2.0
  // 15.946: {6.000, 4.000};   dt=2.500, dx/dt=2.0
  // 18.446: {1.000, 4.000};   dt=2.000, dx/dt=0.5
  // 18.446: {0.000, 4.000}
  /*std::vector<double> breaks = {
      0.000,  2.000,  4.000,  6.500,  6.583,  6.749,  6.914,  7.080,  7.246,
      7.411,  7.577,  7.743,  7.909,  8.074,  8.240,  8.406,  8.572,  8.737,
  ...
  std::vector<std::vector<double>> knots_vec = {
      ...
      {7.765, 2.955}, {7.584, 3.233}, {7.359, 3.476}, {7.098, 3.680},
      {6.806, 3.838}, {6.493, 3.945}, {6.166, 4.000}, {6.000, 4.000},
      {6.166, 4.000}, {6.493, 3.945}, {6.806, 3.838}, {7.098, 3.680},
      {7.359, 3.476}, {7.584, 3.233}, {7.765, 2.955}, {7.898, 2.652},
      {7.979, 2.330}, {8.007, 2.000}, {7.979, 1.670}, {7.898, 1.348},
      {7.765, 1.045}, {7.584, 0.767}, {7.359, 0.524}, {7.098, 0.320},
      {6.806, 0.162}, {6.493, 0.055}, {6.166, 0.000}, {6.000, 0.000},
      {6.166, 0.000}, {6.493, 0.055}, {6.806, 0.162}, {7.098, 0.320},
      {7.359, 0.524}, {7.584, 0.767}, {7.765, 1.045}, {7.898, 1.348},
      {7.979, 1.670}, {8.007, 2.000}, {7.979, 2.330}, {7.898, 2.652},
      {7.765, 2.955}, {7.584, 3.233}, {7.359, 3.476}, {7.098, 3.680},
