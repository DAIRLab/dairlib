...
PelvisPitchTrajGenerator::PelvisPitchTrajGenerator(
    ...
    : plant_(plant),
      ...
      hip_pitch_traj_(hip_pitch_traj),
      pelvis_pitch_traj_(pelvis_pitch_traj),
      axis_(axis) {
  ...
  this->DeclareAbstractOutputPort("pelvis_rot_traj_" + std::to_string(axis),
                                  traj_inst,
                                  &PelvisPitchTrajGenerator::CalcTraj);

  DeclarePerStepDiscreteUpdateEvent(
      &PelvisPitchTrajGenerator::DiscreteVariableUpdate);
}

EventStatus PelvisPitchTrajGenerator::DiscreteVariableUpdate(
    const Context<double>& context,
    DiscreteValues<double>* discrete_state) const {
  return EventStatus::Succeeded();
}

PiecewisePolynomial<double> PelvisPitchTrajGenerator::GeneratePelvisTraj(
  ...
  double pelvis_pitch = pelvis_rpy.pitch_angle();
