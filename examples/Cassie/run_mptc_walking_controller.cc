...
// if it's more than one message?
    ...
    int DoMain(int argc, char* argv[]) {
        ...
        std::unique_ptr<drake::multibody::MultibodyPlant<AutoDiffXd>> plant_ad =
                drake::systems::System<double>::ToAutoDiffXd(plant_wo_spr);
        ...
        TransTaskSpaceTrackingData swing_foot_traj("swing_ft_traj", K_p_swing_foot,
                                                   ...
                                                   plant_w_spr, plant_wo_spr, *plant_ad);
        ...
        RotTaskSpaceTrackingData pelvis_balance_traj(
                ...
                W_pelvis_balance, plant_w_spr, plant_wo_spr, *plant_ad);
        ...
        RotTaskSpaceTrackingData pelvis_heading_traj(
                ...
                W_pelvis_heading, plant_w_spr, plant_wo_spr, *plant_ad);
