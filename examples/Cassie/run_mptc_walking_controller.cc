...
#include "systems/controllers/mptc/modular_passive_tracking_controller.h"
...
using drake::systems::lcm::TriggerTypeSet;
    ...
    using systems::controllers::mptc_data::ComTrackingData;
    using systems::controllers::mptc_data::JointSpaceTrackingData;
    using systems::controllers::mptc_data::RotTaskSpaceTrackingData;
    using systems::controllers::mptc_data::TransTaskSpaceTrackingData;
...
DEFINE_string(gains_filename, "examples/Cassie/osc/mptc_walking_gains.yaml",
...
int DoMain(int argc, char* argv[]) {
  ...
  plant_w_spr.Finalize();
        ...
        std::unique_ptr<drake::multibody::MultibodyPlant<AutoDiffXd>> plant_ad =
                drake::systems::System<double>::ToAutoDiffXd(plant_w_spr);
  ...
  builder.Connect(walking_speed_control->get_output_port(0),
        ...
        auto osc = builder.AddSystem<systems::controllers::ModularPassiveTrackingControl>(
                plant_w_spr, plant_w_spr, *plant_ad, context_w_spr.get(), context_w_spr.get(),
  ...
  TransTaskSpaceTrackingData swing_foot_traj("swing_ft_traj", K_p_swing_foot,
                                             ...
                                             plant_w_spr, plant_w_spr, *plant_ad);
...
//                                      plant_w_spr, plant_w_spr);
  ...
  RotTaskSpaceTrackingData pelvis_balance_traj(
      ...
      W_pelvis_balance, plant_w_spr, plant_w_spr, *plant_ad);
  ...
  RotTaskSpaceTrackingData pelvis_heading_traj(
      ...
      W_pelvis_heading, plant_w_spr, plant_w_spr, *plant_ad);
  ...
  if (FLAGS_publish_osc_data) {
    ...
    builder.Connect(osc->get_mptc_debug_port(), osc_debug_pub->get_input_port());
  }
