...
int DoMain(int argc, char* argv[]) {
  ...
  std::cout << "left_support_duration: " << left_support_duration << std::endl;
  double air_phase_duration = dircon_trajectory.GetStateBreaks(2)(0) -
                              dircon_trajectory.GetStateBreaks(1)(0);
  std::cout << "air_phase_duration: " << air_phase_duration << std::endl;
  fsm_states = {0, 2, 1, 2, 0};
  state_durations = {left_support_duration / 2, air_phase_duration,
                     right_support_duration, air_phase_duration,
                     left_support_duration / 2};
