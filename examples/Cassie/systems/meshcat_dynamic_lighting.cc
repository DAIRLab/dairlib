...
MeshcatDynamicLighting::MeshcatDynamicLighting(
  ...
  state_port_ = this->DeclareVectorInputPort(
                        "x, u, t", OutputVector<double>(plant.num_positions(),
                                                        ...
                                                        plant.num_actuators()))
                    .get_index();
  DeclarePerStepDiscreteUpdateEvent(&MeshcatDynamicLighting::UpdateMeshcat);
}

drake::systems::EventStatus MeshcatDynamicLighting::UpdateMeshcat(
