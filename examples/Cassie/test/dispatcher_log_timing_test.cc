...
// for bot CASSIE_OUTPUT (into the dispatcher) and CASSIE_STATE_DISPATCHER (out
// of the dispatcher). The difference between these two deltas is roughly the
// delay in the dispatcher. This approach to calculating delay does not require
