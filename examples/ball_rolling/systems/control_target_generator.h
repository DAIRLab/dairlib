...
class TargetGenerator
 ...
 public:
  ...
  void SetRemoteControlParameters(const int& trajectory_type, const double& traj_radius,
    ...
    const double& end_point_x, const double& end_point_y, const double& lookahead_step_size, const double& lookahead_angle, const double& max_step_size, const double& ee_goal_height, const double& object_half_width);
 ...
 private:
  ...
  double y_c_;
  double lead_angle_;
  Eigen::VectorXd fixed_target_position_;
