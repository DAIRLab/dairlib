...
DEFINE_string(trajectory_settings,
              "examples/box_topple/parameters/trajectory_params.yaml",
...
int DoMain(int argc, char* argv[]) {
  ...
  FrankaSimParams sim_params = drake::yaml::LoadYamlFile<FrankaSimParams>(
      "examples/box_topple/parameters/franka_sim_params.yaml");
...
std::vector<SortedPair<GeometryId>> ground_object_contact_pairs;
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/box_topple/franka_c3_controller");
  DrawAndSaveDiagramGraph(*plant_diagram, "examples/box_topple/franka_c3_plant");
  ...
  DrawAndSaveDiagramGraph(*loop.get_diagram(), "examples/box_topple/loop");
