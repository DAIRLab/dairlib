...
#include "examples/box_topple/parameters/franka_lcm_channels.h"
#include "examples/box_topple/parameters/franka_osc_controller_params.h"
#include "examples/box_topple/systems/end_effector_force_trajectory.h"
#include "examples/box_topple/systems/end_effector_orientation.h"
#include "examples/box_topple/systems/end_effector_trajectory.h"
...
#include "examples/box_topple/systems/joint_trajectory_generator.h"
...
DEFINE_string(osqp_settings,
              "examples/box_topple/parameters/franka_osc_qp_settings.yaml",
              "Filepath containing qp settings");
DEFINE_string(controller_parameters,
              "examples/box_topple/parameters/franka_osc_controller_params.yaml",
              "Controller settings such as channels. Attempting to minimize "
              "number of gflags");
DEFINE_string(lcm_channels,
              "examples/box_topple/parameters/lcm_channels_simulation.yaml",
...
int DoMain(int argc, char* argv[]) {
  ...
  if (controller_params.cancel_gravity_compensation) {
    if (FLAGS_lcm_channels == "examples/box_topple/parameters/lcm_channels_simulation.yaml"){
    ...
    if (FLAGS_lcm_channels ==
        "examples/box_topple/parameters/lcm_channels_hardware.yaml") {
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/box_topple/new_franka_osc_controller");
