...
int DoMain(int argc, char* argv[]) {
  ...
  if (controller_params.cancel_gravity_compensation) {
    ...
    if (FLAGS_lcm_channels == "examples/box_topple/parameters/lcm_channels_hardware.yaml"){
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/box_topple/franka_osc_controller");
