...
#include "examples/box_topple/systems/c3_mode_visualizer.h"
#include "examples/box_topple/systems/sample_buffer_to_point_cloud.h"
...
int do_main(int argc, char* argv[]) {
  ...
  DrawAndSaveDiagramGraph(*diagram, "examples/box_topple/visualizer_diagram");
