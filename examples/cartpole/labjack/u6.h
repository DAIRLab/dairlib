...
long getTdacCalibrationInfo(LABJACK_HANDLE hDevice,
...
long I2C(LABJACK_HANDLE hDevice,
         uint8 I2COptions,
         uint8 SpeedAdjust,
         uint8 SDAPinNum,
         uint8 SCLPinNum,
...
long eAIN(LABJACK_HANDLE Handle,
...
long eDAC(LABJACK_HANDLE Handle,
          u6CalibrationInfo *CalibrationInfo,
          long Channel,
          double Voltage,
          long Binary,
...
long eDI(LABJACK_HANDLE Handle,
         long Channel,
         long *State);
...
long eDO(LABJACK_HANDLE Handle,
         long Channel,
         long State);
...
long eTCConfig(LABJACK_HANDLE Handle,
               long *aEnableTimers,
...
long eTCValues(LABJACK_HANDLE Handle,
               long *aReadTimers,
...
long ehConfigIO(LABJACK_HANDLE hDevice,
                uint8 inWriteMask,
...
long ehConfigTimerClock(LABJACK_HANDLE hDevice,
...
long ehFeedback(LABJACK_HANDLE hDevice,
