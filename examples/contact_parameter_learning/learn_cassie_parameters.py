...
drake_sim = drake_cassie_sim.DrakeCassieSim(drake_sim_dt=8e-5, loss_filename='cassie_loss_weights')
mujoco_sim = mujoco_cassie_sim.LearningMujocoCassieSim(loss_filename='cassie_loss_weights')
loss_over_time = []
stiffness_over_time = []
params_over_time = []
log_num = 'training'
