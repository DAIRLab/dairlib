...
#include "examples/cube_flip/parameter_headers/allegro_controller_params.h"
#include "examples/cube_flip/parameter_headers/allegro_lcm_channels.h"
...
DEFINE_string(controller_settings,
              "examples/cube_flip/parameters/allegro_controller_params.yaml",
