...
#include "examples/cube_franka/systems/c3_trajectory_source.h"
#include "examples/cube_franka/systems/gravity_compensator.h"
#include "systems/robot_lcm_systems.h"
#include "systems/controllers/impedance_controller_cube.h"
...
int DoMain(int argc, char* argv[]){
  ...
  msg_data[13] = param.jack_half_width + param.table_offset;
