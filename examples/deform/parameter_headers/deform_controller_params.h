...
struct DeformControllerParams {
  ...
  std::string reduced_model_params_file;       // reduced model params
  ...
  // SamplingC3GoalParams stored internally for convenience in passing to
  ...
  void Serialize(Archive* a) {
    ...
    std::cout << "Loading from " << elastoplastic_sc3_options_file << std::endl;
    std::cout << "Loaded elastoplastic SC3 options and got "
                 "elastoplastic_sc3_options.lcs_dt_resolution: "
              << elastoplastic_sc3_options.lcs_dt_resolution << std::endl;
    reduced_model_params = drake::yaml::LoadYamlFile<ReducedModelParams>(
        reduced_model_params_file);
    ...
    elastoplastic_goal_params =
        drake::yaml::LoadYamlFile<ElastoPlasticGoalParams>(goal_params_file);

    // num_nodes = 0;  // TODO

    // Set the SamplingC3GoalParams based on ElastoPlasticGoalParams since this
    // object type is needed for the SamplingC3Controller initializer.  These
    // values don't matter since ElastoPlasticSC3Controller uses
    // ElastoPlasticGoalParams directly.
    goal_params = {
        .goal_mode = elastoplastic_goal_params.goal_mode,
        .position_success_threshold =
            elastoplastic_goal_params.node_success_threshold,
        .orientation_success_threshold = 0,  // NO DEFORM EQUIVALENT
        .only_use_xy_position = false,       // NO DEFORM EQUIVALENT
        .resting_object_heights = {},        // NO DEFORM EQUIVALENT
        .ee_target_z_offset_above_object =
            elastoplastic_goal_params.ee_target_z_offset_above_object,
        .lookahead_step_size = elastoplastic_goal_params.lookahead_step_size,
        .lookahead_angle = 0,             // NO DEFORM EQUIVALENT
        .angle_hysteresis = 0,            // NO DEFORM EQUIVALENT
        .angle_err_to_vel_factor = 0,     // NO DEFORM EQUIVALENT
        .fixed_target_positions = {},     // NO DEFORM EQUIVALENT
        .fixed_target_orientations = {},  // NO DEFORM EQUIVALENT
        .sampling_area_y_limits = {},     // NO DEFORM EQUIVALENT
        .default_object_index_to_sampling_area_index_map =
            {},  // NO DEFORM EQUIVALENT
        .random_goal_x_limits = elastoplastic_goal_params.random_goal_x_limits,
        .random_goal_y_limits = elastoplastic_goal_params.random_goal_y_limits,
        .random_goal_radius_limits =
            elastoplastic_goal_params.random_goal_radius_limits,
        .random_goal_gen_max_attempts = 0,  // NO DEFORM EQUIVALENT
        .pairwise_goal_distance = 0,        // NO DEFORM EQUIVALENT
    };
    ...
    sampling_c3_controller_params.workspace_margin = workspace_margin;
    ...
    sampling_c3_controller_params.sampling_c3_options =
        elastoplastic_sc3_options;
    sampling_c3_controller_params.reposition_params = reposition_params;
    sampling_c3_controller_params.progress_params = progress_params;
    sampling_c3_controller_params.sampling_params = sampling_params;
    // Set the goal params to the non-elastoplastic version.
    sampling_c3_controller_params.goal_params = goal_params;
    // Elastoplastic demo has 0 objects.
    sampling_c3_controller_params.object_models = {};
    sampling_c3_controller_params.base_names = {};
    sampling_c3_controller_params.num_objects = 0;
  }
};
