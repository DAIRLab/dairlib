...
drake::trajectories::PiecewisePolynomial<double> run_traj_opt(
  ...
  //  input constraints
  trajopt->AddConstraintToAllKnotPoints(u(0) >= -35);
  trajopt->AddConstraintToAllKnotPoints(u(1) >= -35);
  trajopt->AddConstraintToAllKnotPoints(u(2) >= -35);
  trajopt->AddConstraintToAllKnotPoints(u(3) >= -35);
  trajopt->AddConstraintToAllKnotPoints(u(0) <= 35);
  trajopt->AddConstraintToAllKnotPoints(u(1) <= 35);
  trajopt->AddConstraintToAllKnotPoints(u(2) <= 35);
  trajopt->AddConstraintToAllKnotPoints(u(3) <= 35);
