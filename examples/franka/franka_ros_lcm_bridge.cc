...
int DoMain(int argc, char* argv[]) {
  ...
  FrankaLcmChannels ros_channel_params =
      drake::yaml::LoadYamlFile<FrankaLcmChannels>(FLAGS_ros_channels);
  ...
  builder.Connect(ros_to_lcm_robot_state->get_output_port(),
                  robot_output_pub->get_input_port());
  ...
  builder.Connect(ros_to_lcm_object_state->get_output_port(),
                  ball_position_pub->get_input_port());
  ...
  auto lcm_to_ros_robot_input =
      builder.AddSystem<systems::TimestampedVectorToROS>(7);
