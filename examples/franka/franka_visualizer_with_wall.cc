...
int do_main(int argc, char* argv[]) {
  ...
  drake::multibody::ModelInstanceIndex wall_index =
      parser.AddModels(FindResourceOrThrow(sim_params.wall_model))[0];
  RigidTransform<double> T_Wall_W = RigidTransform<double>(
