#include "franka_ros_lcm_conversions.h"
...
LcmToRosTimestampedVector::LcmToRosTimestampedVector(int vector_size)
  ...
  this->DeclareVectorInputPort("u, t",
                               TimestampedVector<double>(vector_size_));
  this->DeclareAbstractOutputPort("ROS Float64MultiArray",
                                  &LcmToRosTimestampedVector::ConvertToROS);
};

void LcmToRosTimestampedVector::ConvertToROS(const drake::systems::Context<double>& context,
...
RosToLcmRobotState::RosToLcmRobotState(int num_positions, int num_velocities, int num_efforts)
...
void RosToLcmRobotState::ConvertToLCM(const drake::systems::Context<double>& context,
...
void RosToLcmFrankaState::ConvertToLCM(const drake::systems::Context<double>& context,
...
/***************************************************************************************/
// RosToLcmObjectState implementation
...
void RosToLcmObjectState::ConvertToLCM(const drake::systems::Context<double>& context,
