...
void CassiePlannerWithMixedRomFom::SolveTrajOpt(
  ...
  // iter 1 sim
  //  x_init << 0.999996642424981, -0.001549959478642, -0.001332661503229,
  //      -0.001986406434981, 0, 0, 0.953977967173752,
  //      -0.043905366353395, 0.039053062586564, 0.016831983305486,
  //      -0.009180600041229, 0.663972629955771, 0.45182207916068,
  //      -1.34528747374443, -1.37511855135525, 1.57565770747709,
  //      1.59915644772633,
  //      -1.76969874933875, -1.54500451520281,  // q
  //      -0.091998157364025, -0.0160591229653, 0.033186864106298,
  //      0.599786933850355, 0.154772416613226, 0.001811273945731,
  //      -0.060522658640023, -0.081828008297938, -0.03305254545943,
  //      -0.015148458987506, -0.494986222624165, 0.137019212902996,
  //      -0.391851703914776, -0.752699392794922, 0.241037940014398,
  //      0.735791481405087, 0.629310929536191, 0.157473934219539;
  // iter 50 sim
  //  x_init << 0.999997967018394, -0.001002088093031, -0.00117907276305,
  //      -0.001859648563641, 0, 0,
  //      0.96650945417144, -0.052879042180903, 0.050023233398288,
  //      0.012542245493283, -0.004326625021346, 0.653618091508306,
  //      0.427657448206801, -1.30013697933029, -1.33300304315244,
  //      1.52854891966873,
  //      1.55699628837494, -1.7571865663845,
  //      -1.5211167069077,  // q
  //      -0.078826670466366, -0.018481415941617, 0.03549645512286,
  //      0.624783578938543, 0.13698498691349, 0.053998405046802,
  //      -0.052445415632845, -0.074053118354915, -0.035289808065629,
  //      -0.011095942457676, -0.46648952052678, 0.077953307468253,
  //      -0.381960973775278, -0.63547765924162, 0.076530701398691,
  //      0.616357997246015, 0.75120239046053, 0.18721814923232;
