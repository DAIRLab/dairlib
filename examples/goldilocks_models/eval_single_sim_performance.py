...
# Below is the code before I added regularization terms. I keep it so that I can toggle to compare the result (make sure there is no bug in the new code)
################################################################################
#
#
# import sys
...
#   print("w_Q = " + str(w_Q))
#   print("w_R = " + str(w_R))
#   print("w_accel_multiplier = " + str(w_accel_multiplier))
#
