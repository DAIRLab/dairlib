...
void runSampleTrajopt(/*const MultibodyPlant<double> & plant,
                      ...
                      string directory, string init_file, string prefix) {
  // Create MBP
  ...
  // contact point constraint in the x and z direction
  ...
  // std::cout<<"leftDataSet.countConstraints() =
  // "<<leftDataSet.countConstraints()<<"\n";
  ...
  //                num_time_samples, min_dt, max_dt, dataset_list,
  //                options_list);
  HybridDircon<double> trajopt(plant, num_time_samples, min_dt, max_dt,
                               dataset_list, options_list);
  ...
  // Careful! if you have a string typo, the code still runs and the mapped
  // value will be 0.
  // trajopt.AddLinearConstraint(x0(positions_map.at("planar_z")) == xf(
  //                                positions_map.at("planar_z")));
  trajopt.AddLinearConstraint(x0(positions_map.at("planar_roty")) ==
                              xf(positions_map.at("planar_roty")));
  trajopt.AddLinearConstraint(x0(positions_map.at("left_hip_pin")) ==
                              xf(positions_map.at("right_hip_pin")));
  trajopt.AddLinearConstraint(x0(positions_map.at("left_knee_pin")) ==
                              xf(positions_map.at("right_knee_pin")));
  trajopt.AddLinearConstraint(x0(positions_map.at("right_hip_pin")) ==
                              xf(positions_map.at("left_hip_pin")));
  trajopt.AddLinearConstraint(x0(positions_map.at("right_knee_pin")) ==
                              xf(positions_map.at("left_knee_pin")));
  ...
  trajopt.AddLinearConstraint(
      x0(n_q + velocities_map.at("right_knee_pindot")) ==
      xf(n_q + velocities_map.at("left_knee_pindot")));

  // u periodic constraint
  auto u0 = trajopt.input(0);
  auto uf = trajopt.input(N - 1);
  trajopt.AddLinearConstraint(u0(actuators_map.at("left_hip_torque")) ==
                              uf(actuators_map.at("right_hip_torque")));
  trajopt.AddLinearConstraint(u0(actuators_map.at("right_hip_torque")) ==
                              uf(actuators_map.at("left_hip_torque")));
  trajopt.AddLinearConstraint(u0(actuators_map.at("left_knee_torque")) ==
                              uf(actuators_map.at("right_knee_torque")));
  trajopt.AddLinearConstraint(u0(actuators_map.at("right_knee_torque")) ==
                              uf(actuators_map.at("left_knee_torque")));
