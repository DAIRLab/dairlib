...
/// condition?)
/// This script takes care of sending the messages from controller thread to the
/// planner (which runs on the station), while the other script takes care of
/// sending robot state message from dispatcher_out to the planner (which runs
/// on the station).
