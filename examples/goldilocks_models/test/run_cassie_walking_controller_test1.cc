...
int DoMain(int argc, char* argv[]) {
  ...
  // I commented out the code below. We don't need the whole controller to benchmark OptimalRomTrackingData eval time.
  ...
  //         plant_w_springs, context_w_spr.get(), FLAGS_footstep_option,
