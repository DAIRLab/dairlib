...
#include "examples/iC3/plate/parameter_headers/franka_plate_osc_controller_params.h"
...
DEFINE_string(osqp_settings,
              "examples/iC3/plate/parameters/franka_plate_osc_qp_settings.yaml",
              "Filepath containing qp settings");
DEFINE_string(controller_parameters,
              "examples/iC3/plate/parameters/franka_plate_osc_controller_params.yaml",
