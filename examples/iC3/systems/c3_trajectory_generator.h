...
class C3TrajectoryGenerator : public drake::systems::LeafSystem<double> {
 public:
  ...
  explicit C3TrajectoryGenerator(
    ...
    c3::multibody::LCSFactory lcs_factory, std::vector<drake::SortedPair<drake::geometry::GeometryId>> contact_pairs, 
    iC3Options ic3_options, c3::systems::C3ControllerOptions c3_controller_options, bool track_dynamically_feasible, 
