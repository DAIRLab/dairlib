...
int RunToySystem(drake::lcm::DrakeLcm& lcm) {
  ...
  C3ControllerOptions c3_controller_options =
      drake::yaml::LoadYamlFile<C3ControllerOptions>(
          "examples/iC3/toy_system/toy_c3_hand_options.yaml");
  ...
  const std::string ee_file_lcs = "examples/iC3/urdf/fingertips_lcs.sdf";
	const std::string cube_file_lcs = "examples/iC3/urdf/cube_for_lcs.sdf";
	const std::string ground_file_lcs = "examples/iC3/urdf/ground.urdf";
  ...
  const std::string ee_file = "examples/iC3/urdf/fingertips_lcs.sdf";
