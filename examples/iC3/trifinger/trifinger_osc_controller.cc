...
#include "examples/iC3/trifinger/systems/trifinger_position_splitter.h"
...
DEFINE_string(osqp_settings,
              "examples/iC3/trifinger/parameters/trifinger_osc_qp_settings.yaml",
...
int DoMain(int argc, char* argv[]) {
  ...
  if (controller_params.cancel_gravity_compensation) {
    ...
    if (FLAGS_lcm_channels ==
        "examples/iC3/trifinger/parameters/lcm_channels_hardware.yaml") {
