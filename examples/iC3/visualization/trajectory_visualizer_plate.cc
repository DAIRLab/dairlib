...
#include "examples/iC3/visualization/trajectory_lcm_parser_plate.h"
...
int do_main(int argc, char* argv[]) {
  ...
  CubeFlipVisualizerParams vis_params =
      drake::yaml::LoadYamlFile<CubeFlipVisualizerParams>("examples/iC3/visualization/parameters/trajectory_vis_params_plate.yaml");
