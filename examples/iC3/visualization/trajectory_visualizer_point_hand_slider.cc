...
#include "examples/iC3/visualization/meshcat_slider_system.h"
...
int do_main(int argc, char* argv[]) {
  ...
  CubeFlipVisualizerParams vis_params =
      drake::yaml::LoadYamlFile<CubeFlipVisualizerParams>("examples/iC3/visualization/parameters/trajectory_vis_params_point_hand.yaml");
...
//   std::cout << "plant built" << std::endl;
  ...
  auto cube_trajectory_splitter =
      builder.AddSystem<PointHandPoseGetter>(vis_params, 0, "cube_trajectory_splitter");

  auto c3_trajectory_splitter =
      builder.AddSystem<PointHandPoseGetter>(vis_params, 0, "c3_trajectory_splitter");

  auto hand_splitter = 
      builder.AddSystem<PointHandPoseGetter>(vis_params, 1, "hand_trajectory_splitter");

  auto c3_hand_splitter = 
      builder.AddSystem<PointHandPoseGetter>(vis_params, 1, "c3_hand_trajectory_splitter");
  ...
  meshcat->AddSlider("time_slider", 0, vis_params.trajectory_length-1, 1, 0);

  auto meshcat_slider_system = 
      builder.AddSystem<MeshcatSliderSystem>(meshcat, "time_slider");
