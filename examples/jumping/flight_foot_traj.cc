...
FlightFootTraj::FlightFootTraj(const RigidBodyTree<double> &tree, int hip_idx,
    ...
    : tree_(tree), hip_idx_(hip_idx), left_foot_idx_(left_foot_idx),
      right_foot_idx_(right_foot_idx), isLeftFoot_(isLeftFoot),
      foot_traj_(foot_traj), height_(height) {
