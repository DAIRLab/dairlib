 ...
 */
drake::multibody::DeformableBodyId RegisterRoundBelt(
    drake::multibody::DeformableModel<double>* model, const std::string& model_name,
    const drake::math::RigidTransformd& X_WB,
    const drake::multibody::fem::DeformableBodyConfig<double>& deformable_config,
