...
#include "parameter_headers/timing_belt_controller_params.h"
...
class TimingBeltController : public drake::systems::LeafSystem<double> {
 public:
  TimingBeltController(
 ...
 private:
  ...
  mutable TimingBeltControllerParams timing_belt_controller_params_;
