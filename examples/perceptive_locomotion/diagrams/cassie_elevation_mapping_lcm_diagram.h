...
class CassieElevationMappingLcmDiagram : public drake::systems::Diagram<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(CassieElevationMappingLcmDiagram);
  CassieElevationMappingLcmDiagram(const std::string& params_yaml,
                                   const std::string& points_channel);
