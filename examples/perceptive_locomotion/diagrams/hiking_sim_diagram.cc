...
HikingSimDiagram::HikingSimDiagram(
    ...
    : urdf_("examples/Cassie/urdf/cassie_v2_toe_link.urdf") {//: urdf_("examples/Cassie/urdf/cassie_v2_self_collision.urdf") { // "examples/Cassie/urdf/cassie_v2_toe_link.urdf"
