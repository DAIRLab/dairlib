...
class RLOscDiagram : public drake::systems::Diagram<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(RLOscDiagram)

  // TODO (@Brian-Acosta) Add factory method for getting the plant
  RLOscDiagram(const drake::multibody::MultibodyPlant<double>& plant,
  ...
  [[nodiscard]] const InputPort<double>& get_input_port_rl() const {
