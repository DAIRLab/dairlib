...
SimDiagram::SimDiagram(const std::string& mpc_gains_yaml,
...
void SimDiagram::SetPlantInitialConditions(
...
drake::math::RigidTransformd SimDiagram::GetCassiePelvisPoseInWorld(
...
void SimDiagram::SaveLcmLog(const std::string &fname) {
