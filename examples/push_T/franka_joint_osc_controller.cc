...
#include "examples/push_T/parameters/franka_osc_controller_params.h"
#include "examples/push_T/systems/end_effector_force_trajectory.h"
#include "examples/push_T/systems/end_effector_orientation.h"
#include "examples/push_T/systems/end_effector_trajectory.h"
...
#include "examples/push_T/systems/joint_trajectory_generator.h"
...
DEFINE_string(osqp_settings,
              "examples/push_T/parameters/franka_osc_qp_settings.yaml",
              "Filepath containing qp settings");
DEFINE_string(controller_parameters,
              "examples/push_T/parameters/franka_osc_controller_params.yaml",
...
int DoMain(int argc, char* argv[]) {
  ...
  if (controller_params.cancel_gravity_compensation) {
    if (FLAGS_lcm_channels == "examples/push_T/parameters/lcm_channels_simulation.yaml"){
    ...
    if (FLAGS_lcm_channels ==
        "examples/push_T/parameters/lcm_channels_hardware.yaml") {
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/push_T/new_franka_osc_controller");
