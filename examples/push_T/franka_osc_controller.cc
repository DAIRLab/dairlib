...
int DoMain(int argc, char* argv[]) {
  ...
  if (controller_params.cancel_gravity_compensation) {
    ...
    if (FLAGS_lcm_channels == "examples/push_T/parameters/lcm_channels_hardware.yaml"){
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/push_T/franka_osc_controller");
