...
#include "examples/push_T/systems/c3_mode_visualizer.h"
#include "examples/push_T/systems/sample_buffer_to_point_cloud.h"
...
int do_main(int argc, char* argv[]) {
  ...
  DrawAndSaveDiagramGraph(*diagram, "examples/push_T/visualizer_diagram");
