...
LOAD_DIR = op.join(DAIRLIB_DIR, 'examples/push_T/test/tmp')
...
ee_urdf = op.join(DAIRLIB_DIR, 'examples/push_T/urdf/end_effector_simple_model.urdf')
jack_urdf = op.join(DAIRLIB_DIR, 'examples/push_T/urdf/T_vertical.sdf')
...
Parser(plant).AddModels(jack_urdf.replace('T_vertical.sdf', 'ground.urdf'))
...
AddFrameTriadIllustration(
    plant=plant, scene_graph=scene_graph, body=plant.GetBodyByName("vertical_link"),
