...
#include "examples/sampling_c3/ball_rolling/parameters/franka_c3_controller_params.h"
#include "examples/sampling_c3/ball_rolling/parameters/franka_lcm_channels.h"
#include "examples/sampling_c3/ball_rolling/parameters/franka_sim_params.h"
...
DEFINE_string(controller_settings,
              "examples/sampling_c3/ball_rolling/parameters/franka_c3_controller_params.yaml",
              "Controller settings such as channels. Attempting to minimize "
              "number of gflags");
DEFINE_string(trajectory_settings,
              "examples/sampling_c3/ball_rolling/parameters/trajectory_params.yaml",
              "Trajectory settings such as trajectory type, size/shape, and "
              "goal location.");
DEFINE_string(sampling_settings,
              "examples/sampling_c3/ball_rolling/parameters/sampling_params.yaml",
...
int DoMain(int argc, char* argv[]) {
  ...
  FrankaSimParams sim_params = drake::yaml::LoadYamlFile<FrankaSimParams>(
      "examples/sampling_c3/ball_rolling/parameters/franka_sim_params.yaml");
...
//   auto mode_selector = builder.AddSystem<systems::ModeSelector>();
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/sampling_c3/ball_rolling/franka_c3_controller");
  DrawAndSaveDiagramGraph(*plant_diagram, "examples/sampling_c3/ball_rolling/franka_c3_plant");
  ...
  DrawAndSaveDiagramGraph(*loop.get_diagram(), "examples/sampling_c3/ball_rolling/loop");
