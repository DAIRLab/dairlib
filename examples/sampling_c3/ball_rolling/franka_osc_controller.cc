...
#include "examples/sampling_c3/ball_rolling/parameters/franka_osc_controller_params.h"
...
DEFINE_string(osqp_settings,
              "examples/sampling_c3/ball_rolling/parameters/franka_osc_qp_settings.yaml",
              "Filepath containing qp settings");
DEFINE_string(controller_parameters,
              "examples/sampling_c3/ball_rolling/parameters/franka_osc_controller_params.yaml",
...
//   }
  ...
  if (controller_params.cancel_gravity_compensation) {
    ...
    if (FLAGS_lcm_channels == "examples/sampling_c3/ball_rolling/parameters/lcm_channels_hardware.yaml"){
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/sampling_c3/ball_rolling/franka_osc_controller");
