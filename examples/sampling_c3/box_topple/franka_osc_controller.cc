...
#include "examples/sampling_c3/box_topple/parameters/franka_osc_controller_params.h"
...
int DoMain(int argc, char* argv[]) {
  ...
  if (controller_params.cancel_gravity_compensation) {
    if (FLAGS_lcm_channels == "examples/sampling_c3/box_topple/parameters/lcm_channels_simulation.yaml"){
    ...
    if (FLAGS_lcm_channels == "examples/sampling_c3/box_topple/parameters/lcm_channels_hardware.yaml"){
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/sampling_c3/box_topple/franka_osc_controller");
