...
int DoMain(int argc,  char* argv[]) {
  ...
  DrawAndSaveDiagramGraph(
    *plant_diagram, "examples/sampling_c3/jacktoy/test/franka_c3_plant_in_log_loader");
  ...
  DrawAndSaveDiagramGraph(
    *owned_diagram, "examples/sampling_c3/jacktoy/test/franka_c3_controller_in_log_loader");
...
void PythonFriendlyVectorOfVectorXdToFile(
  char* name, std::vector<Eigen::VectorXd> some_vector) {
  std::string filename = "/home/sharanya/workspace/dairlib/examples/sampling_c3/jacktoy/test";
  filename += "/tmp/";
  filename += name;
  filename += ".txt";
