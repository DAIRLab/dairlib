...
python examples/sampling_c3/jacktoy/test/lcm_log_utils.py single /mnt/data2/sharanya/logs/2024/12_16_24/000006/ --interactive --start=50 --end=100
"""
...
ACTUAL_JACK_URDF_PATH = 'examples/sampling_c3/urdf/jack_with_triad.urdf'
GOAL_JACK_URDF_PATH = 'examples/sampling_c3/urdf/goal_triad.urdf'
CAMERA_URDF_PATH = 'examples/sampling_c3/urdf/camera_model.urdf'
SECOND_CAMERA_URDF_PATH = 'examples/sampling_c3/urdf/camera_model_2.urdf'
...
def save_current_figure(filename: str, store_folder: str = None):
    if store_folder is not None:
        ...
        plt.savefig(f'examples/sampling_c3/jacktoy/test/tmp/{filename}.png')
        print(f'Wrote plot to examples/sampling_c3/jacktoy/test/tmp/{filename}.png')
...
class ProgressVideoMaker:
    ...
    def __init__(self, save_dir: str, open_meshcat: bool = False,
        ...
        self.save_dir = save_dir if save_dir is not None \
            else 'examples/sampling_c3/jacktoy/test/tmp'
...
def multi_command(log_folders: Tuple[str], save_to: str, interactive: bool,
    ...
    if save_to is not None:
        save_folder = op.join('examples/sampling_c3/jacktoy/test/tmp/', save_to)
