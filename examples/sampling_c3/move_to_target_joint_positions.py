...
WAIT_TIME_BETWEEN_TARGETS = 11.0
...
def main():
    ...
    target_joint_positions = np.array(
        [
            ...
            [1.328, 1.363, -1.084, -0.949, 1.361, 1.961, 2.772],    # far left
            [1.146, 0.042, -1.552, -1.599, 1.438, 1.141, 2.169],    # top new
            [2.120, -1.128, -2.758, -0.915, -0.639, 2.156, -1.343], # far right
