...
#include "examples/sampling_c3/push_t/parameters/trajectory_params.h"
...
DEFINE_string(trajectory_settings,
              "examples/sampling_c3/push_t/parameters/trajectory_params.yaml",
              "Trajectory settings such as trajectory type, size/shape, and "
              "goal location.");
DEFINE_string(lcm_channels,
              "examples/sampling_c3/push_t/parameters/lcm_channels_simulation.yaml",
...
int DoMain(int argc, char* argv[]) {
  ...
  FrankaSimParams sim_params = drake::yaml::LoadYamlFile<FrankaSimParams>(
      "examples/sampling_c3/push_t/parameters/franka_sim_params.yaml");
...
std::vector<SortedPair<GeometryId>> ground_object_contact_pairs;
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/sampling_c3/push_t/franka_c3_controller");
  DrawAndSaveDiagramGraph(*plant_diagram, "examples/sampling_c3/push_t/franka_c3_plant");
  ...
  DrawAndSaveDiagramGraph(*loop.get_diagram(), "examples/sampling_c3/push_t/loop");
