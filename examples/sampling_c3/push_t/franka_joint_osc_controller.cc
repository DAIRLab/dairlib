...
int DoMain(int argc, char* argv[]) {
  ...
  if (controller_params.cancel_gravity_compensation) {
    ...
    if (FLAGS_lcm_channels ==
        "examples/sampling_c3/push_t/parameters/lcm_channels_hardware.yaml") {
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/sampling_c3/push_t/new_franka_osc_controller");
