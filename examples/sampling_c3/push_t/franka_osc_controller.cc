...
#include "examples/sampling_c3/push_t/parameters/franka_osc_controller_params.h"
...
DEFINE_string(osqp_settings,
              "examples/sampling_c3/push_t/parameters/franka_osc_qp_settings.yaml",
              "Filepath containing qp settings");
DEFINE_string(controller_parameters,
              "examples/sampling_c3/push_t/parameters/franka_osc_controller_params.yaml",
...
int DoMain(int argc, char* argv[]) {
  ...
  if (controller_params.cancel_gravity_compensation) {
    if (FLAGS_lcm_channels == "examples/sampling_c3/push_t/parameters/lcm_channels_simulation.yaml"){
    ...
    if (FLAGS_lcm_channels == "examples/sampling_c3/push_t/parameters/lcm_channels_hardware.yaml"){
  ...
  DrawAndSaveDiagramGraph(*owned_diagram, "examples/sampling_c3/push_t/franka_osc_controller");
