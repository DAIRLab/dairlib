...
int main() {
  ...
  //       template <typename T>
  //       MatrixX<T> ExponentialPlusPiecewisePolynomial<T>::value(double t)
  //       const {
  ...
  PiecewisePolynomial<double> pp_part =
      PiecewisePolynomial<double>::CubicShapePreserving(T1_breakpoint, Y1,
                                                        true);
  ...
  for (double d = 0; d <= 1; d += 0.1) {
    ...
    std::cout << "t=" << d << ": (" << exp_traj3.value(d) << ", " << fromMath
              << ")\n";
  }
  ...
  PiecewisePolynomial<double> pp_part3 =
      PiecewisePolynomial<double>::CubicShapePreserving(T1_breakpoint, Y3,
                                                        true);
  ...
  K3 << 3, 2, 0, 0, 0, 0, 1.2, -5;
  A3 << 6, 0, 0, 0, 0, -0.5, 0, 0, 0, 0, 10, 0, 0, 0, 0, -10;
  alpha3 << 1, 1, 1, 1;
