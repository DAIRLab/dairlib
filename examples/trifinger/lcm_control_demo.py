...
Qinit = 0*np.eye(31)
Qinit[0:9,0:9] = 10*np.eye(9) #trifinger
Qinit[9:16,9:16] = 0*np.eye(7) #cube
...
ground_geoms = plant_f.GetCollisionGeometriesForBody(plant_f.world_body())[0]

contact_geoms = [finger_lower_link_0_geoms, finger_lower_link_120_geoms, finger_lower_link_240_geoms, cube_geoms, ground_geoms]
