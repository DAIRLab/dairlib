...
// Using constructor with an arbitrary name input provided.
MultiposeVisualizer::MultiposeVisualizer(string model_file, int num_poses,
                                         const Eigen::VectorXd& alpha_scale,
                                         string weld_frame_to_world,
                                         std::shared_ptr<Meshcat> meshcat, const std::string& name)
  ...
  Parser parser(plant_, scene_graph, name + "_pose_trace");
