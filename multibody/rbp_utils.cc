...
template<typename T>
VectorX<T> CalcMVdot(RigidBodyPlant<double>* plant,
                              VectorX<T> q,
                              VectorX<T> v,
                              VectorX<T> u, 
                              VectorX<T> lambda) {
...
template<typename T>
VectorX<T> CalcTimeDerivativesUsingLambda(RigidBodyPlant<T>* plant, 
                                        VectorX<T> x,
                                        VectorX<T> u,
                                        VectorX<T> lambda) {
...
template VectorX<double> CalcTimeDerivativesUsingLambda<double>(RigidBodyPlant<double>*,
                                                        VectorX<double>,
                                                        VectorX<double>,
                                                        VectorX<double>);

template VectorX<AutoDiffXd> CalcTimeDerivativesUsingLambda<AutoDiffXd>(RigidBodyPlant<AutoDiffXd>*,
                                                        VectorX<AutoDiffXd>,
                                                        VectorX<AutoDiffXd>,
                                                        VectorX<AutoDiffXd>);

template VectorX<double> CalcMVdot<double>(RigidBodyPlant<double>*,
                                           VectorX<double>,
                                           VectorX<double>,
                                           VectorX<double>,
                                           VectorX<double>);

template VectorX<AutoDiffXd> CalcMVdot<AutoDiffXd>(RigidBodyPlant<double>*,
                                                   VectorX<AutoDiffXd>,
                                                   VectorX<AutoDiffXd>,
                                                   VectorX<AutoDiffXd>,
                                                   VectorX<AutoDiffXd>);
