...
addPlot()
addSignals('NETWORK_CASSIE_STATE_DISPATCHER', msg.utime, msg.position, position_names, keyLookup=pos_names)


# you can assign the plot to a variable and reference it later
p=addPlot()
addSignals('NETWORK_CASSIE_STATE_DISPATCHER', msg.utime, msg.velocity, velocity_names, keyLookup=vel_names, plot=p)


p3 = addPlot()
addSignals('NETWORK_CASSIE_INPUT', msg.utime, msg.efforts, effort_names, keyLookup=eff_names, plot=p3)
