...
q=addPlot()
addSignals('CASSIE_STATE', msg.utime, msg.position, position_names,
           keyLookup=pos_names, plot = q)

# you can assign the plot to a variable and reference it later
v=addPlot()
addSignals('CASSIE_STATE', msg.utime, msg.velocity, velocity_names,
           keyLookup=vel_names, plot=v)

u_standing = addPlot()
addSignals('CASSIE_INPUT', msg.utime, msg.efforts, effort_names,
           keyLookup=eff_names, plot=u_standing)

u_jumping = addPlot()
addSignals('OSC_JUMPING', msg.utime, msg.efforts, effort_names,
           keyLookup=eff_names, plot=u_jumping)
