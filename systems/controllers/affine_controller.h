...
class AffineParams : public TimestampedVector<double> {
 public:
  AffineParams(int num_states, int num_efforts):
      ...
      K_(get_mutable_data().head(num_states * num_efforts).data(), num_efforts,
         num_states),
      E_(get_mutable_data().segment(num_states * num_efforts, num_efforts)
                                      .data(), num_efforts),
      desired_state_(get_mutable_data().segment(num_states * num_efforts +
