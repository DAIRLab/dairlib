...
class iC3TrajTrackingController : public drake::systems::LeafSystem<double> {
 public:
  explicit iC3TrajTrackingController(const drake::multibody::MultibodyPlant<double>& plant,
 ...
 private:
  ...
  void UpdateQuaternionCosts(const Eigen::VectorXd& x_curr, const vector<Eigen::VectorXd> x_des) const;
