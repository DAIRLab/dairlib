...
Vector2d ImposeHalfplaneGuard(Vector2d foot_placement_pos,
  ...
  if (((!left_or_right_stance) && (heading_cross_CoM_to_stance_foot(2) > 0)) ||
      ((left_or_right_stance) && (heading_cross_CoM_to_stance_foot(2) < 0))) {
  ...
  Vector3d CoM_or_stance_foot_to_fp(
      ...
      foot_placement_pos(1) - shifted_CoM_or_stance_foot(1), 0);
...
Vector2d ImposeStepLengthGuard(Vector2d foot_placement_pos, Vector2d CoM,
                               double max_dist) {
