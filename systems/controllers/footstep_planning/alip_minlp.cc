...
void AlipMINLP::AddTrackingCost(vector<vector<Eigen::Vector4d>> xd,
                                Eigen::Matrix4d Q) {
...
void AlipMINLP::CalcOptimalFoostepPlan(const Eigen::Vector4d &x,
...
vector<vector<Vector4d>> AlipMINLP::MakeXdesTrajForVdes(
  ...
  double Ly = H_ * m_ * vdes;
  double Lx = m_ * H_ * omega * step_width * atanh(omega * Ts / 2);
