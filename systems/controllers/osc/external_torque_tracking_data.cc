...
ExternalTorqueTrackingData::ExternalTorqueTrackingData(
...
void ExternalTorqueTrackingData::Update(
  ...
  J_ = MatrixXd::Zero(3, plant_wo_spr_.num_velocities());
  plant_wo_spr_.CalcJacobianAngularVelocity(
      context_wo_spr, JacobianWrtVariable::kV, *body_frame_wo_spr_,
