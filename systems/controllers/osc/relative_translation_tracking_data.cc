...
void RelativeTranslationTrackingData::Update(
  ...
  to_frame_data_->OscTrackingData::Update(x_w_spr, context_w_spr, x_wo_spr,
                                          context_wo_spr, traj, t, t_gait_cycle,
                                          fsm_state, v_proj);
  from_frame_data_->OscTrackingData::Update(x_w_spr, context_w_spr, x_wo_spr,
                                            context_wo_spr, traj, t,
                                            t_gait_cycle, fsm_state, v_proj);
