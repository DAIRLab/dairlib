...
/// RpyTaskSpaceTrackingData is used when we want to track a trajectory
/// (rotational position) in the task space. The desired position must be
/// expressed in body-fixed Z-Y-X euler angles.
...
class RpyTaskSpaceTrackingData final : public OptionsTrackingData {
 public:
