...
/// TimestampedLowpassFilter implements a first order vector-valued linear lowpass filter.
/// Since the control loops we use generally do not have a fixed sampling rate, we implement
/// this filter using timestamped vectors to achieve the  desired time constant
