...
#include "examples/box_topple/parameters/franka_c3_controller_params.h"
...
TargetGeneratorBoxTopple::TargetGeneratorBoxTopple(
...
void TargetGeneratorBoxTopple::CalcEndEffectorTarget(
...
void TargetGeneratorBoxTopple::CalcObjectTarget(
    const drake::systems::Context<double>& context,
...
void TargetGeneratorBoxTopple::CalcObjectVelocityTarget(
    const drake::systems::Context<double>& context,
    BasicVector<double>* target) const {
  const StateVector<double>* object_state =
      (StateVector<double>*)this->EvalVectorInput(context, object_state_port_);
...
void TargetGeneratorBoxTopple::OutputObjectFinalTarget(
    const drake::systems::Context<double>& context,
    BasicVector<double>* target) const {
...
void TargetGeneratorBoxTopple::OutputTargetGeneratorInfo(
  const drake::systems::Context<double>& context,
...
void TargetGeneratorBoxTopple::SetRandomizedTargetFinalObjectPosition() const {
...
bool TargetGeneratorBoxTopple::three_topples_required(const int new_orientation_index)
  const {
...
void TargetGeneratorBoxTopple::SetRandomizedTargetFinalObjectOrientation() const {
  std::random_device rd;
  std::mt19937 gen(rd());
...
void TargetGeneratorBoxTopple::CycleThroughOrientationSequence() const {
