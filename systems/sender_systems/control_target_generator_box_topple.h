...
#define QUAT_RED_DOWN Eigen::Quaterniond(0.0,1.0,0.0,0.0)
#define QUAT_BLUE_UP Eigen::Quaterniond(0.7071,0.7071,0.0,0.0)
#define QUAT_ALL_DOWN Eigen::Quaterniond(0.7071,-0.7071,0.0,0.0)
#define QUAT_GREEN_UP Eigen::Quaterniond(0.7071,0.0,0.7071,0.0)
#define QUAT_BLUE_DOWN Eigen::Quaterniond(0.7071,0.0,-0.7071,0.0)
#define QUAT_ALL_UP Eigen::Quaterniond(1.0,0.0,0.0,0.0)

namespace dairlib {
namespace systems {

class TargetGeneratorBoxTopple
