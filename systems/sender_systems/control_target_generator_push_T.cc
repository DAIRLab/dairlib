#include "control_target_generator_push_T.h"
#include <drake/common/yaml/yaml_io.h>
#include "examples/sampling_c3/push_t/parameters/franka_c3_controller_params.h"
...
TargetGeneratorPushT::TargetGeneratorPushT(
...
void TargetGeneratorPushT::CalcEndEffectorTarget(
...
void TargetGeneratorPushT::CalcObjectTarget(
    const drake::systems::Context<double>& context,
...
void TargetGeneratorPushT::CalcObjectVelocityTarget(
    const drake::systems::Context<double>& context,
    BasicVector<double>* target) const {
  const StateVector<double>* object_state =
      (StateVector<double>*)this->EvalVectorInput(context, object_state_port_);
...
void TargetGeneratorPushT::OutputObjectFinalTarget(
    const drake::systems::Context<double>& context,
    BasicVector<double>* target) const {
...
void TargetGeneratorPushT::OutputTargetGeneratorInfo(
  const drake::systems::Context<double>& context,
...
void TargetGeneratorPushT::SetRandomizedTargetFinalObjectPosition() const {
...
void TargetGeneratorPushT::SetRandomizedTargetFinalObjectOrientation() const {
