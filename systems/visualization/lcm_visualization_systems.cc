...
LcmC3TargetDrawer::LcmC3TargetDrawer(
    const std::shared_ptr<drake::geometry::Meshcat>& meshcat, bool draw_object,
    bool draw_ee)
    : meshcat_(meshcat), draw_object_(draw_object), draw_ee_(draw_ee) {
  ...
  meshcat_->SetObject(c3_target_object_path_ + "/x-axis", cylinder_for_object_,
                      {1, 0, 0, 1});
  meshcat_->SetObject(c3_target_object_path_ + "/y-axis", cylinder_for_object_,
                      {0, 1, 0, 1});
  meshcat_->SetObject(c3_target_object_path_ + "/z-axis", cylinder_for_object_,
                      {0, 0, 1, 1});
  meshcat_->SetObject(c3_actual_object_path_ + "/x-axis", cylinder_for_object_,
                      {1, 0, 0, 1});
  meshcat_->SetObject(c3_actual_object_path_ + "/y-axis", cylinder_for_object_,
                      {0, 1, 0, 1});
  meshcat_->SetObject(c3_actual_object_path_ + "/z-axis", cylinder_for_object_,
                      {0, 0, 1, 1});
  if (draw_ee_){
