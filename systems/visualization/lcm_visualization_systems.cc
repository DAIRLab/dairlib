...
LcmForceDrawer::LcmForceDrawer(
  ...
  force_path_ = "C3/" + system_name + "forces/";
...
LcmC3TargetDrawer::LcmC3TargetDrawer(
  ...
  meshcat_->SetObject(c3_actual_object_path_ + "/z-axis", cylinder_for_tray_,
                      {0, 0, 1, 1});
  if (draw_ee_) {
    meshcat_->SetObject(c3_target_ee0_path_ + "/x-axis", cylinder_for_ee_,
                        {1, 0, 0, 1});
    meshcat_->SetObject(c3_target_ee0_path_ + "/y-axis", cylinder_for_ee_,
                        {0, 1, 0, 1});
    meshcat_->SetObject(c3_target_ee0_path_ + "/z-axis", cylinder_for_ee_,
                        {0, 0, 1, 1});
    meshcat_->SetObject(c3_actual_ee0_path_ + "/x-axis", cylinder_for_ee_,
                        {1, 0, 0, 1});
    meshcat_->SetObject(c3_actual_ee0_path_ + "/y-axis", cylinder_for_ee_,
                        {0, 1, 0, 1});
    meshcat_->SetObject(c3_actual_ee0_path_ + "/z-axis", cylinder_for_ee_,
                        {0, 0, 1, 1});
    meshcat_->SetObject(c3_target_ee120_path_ + "/x-axis", cylinder_for_ee_,
                        {1, 0, 0, 1});
    meshcat_->SetObject(c3_target_ee120_path_ + "/y-axis", cylinder_for_ee_,
                        {0, 1, 0, 1});
    meshcat_->SetObject(c3_target_ee120_path_ + "/z-axis", cylinder_for_ee_,
                        {0, 0, 1, 1});
    meshcat_->SetObject(c3_actual_ee120_path_ + "/x-axis", cylinder_for_ee_,
                        {1, 0, 0, 1});
    meshcat_->SetObject(c3_actual_ee120_path_ + "/y-axis", cylinder_for_ee_,
                        {0, 1, 0, 1});
    meshcat_->SetObject(c3_actual_ee120_path_ + "/z-axis", cylinder_for_ee_,
                        {0, 0, 1, 1});
    meshcat_->SetObject(c3_target_ee240_path_ + "/x-axis", cylinder_for_ee_,
                        {1, 0, 0, 1});
    meshcat_->SetObject(c3_target_ee240_path_ + "/y-axis", cylinder_for_ee_,
                        {0, 1, 0, 1});
    meshcat_->SetObject(c3_target_ee240_path_ + "/z-axis", cylinder_for_ee_,
                        {0, 0, 1, 1});
    meshcat_->SetObject(c3_actual_ee240_path_ + "/x-axis", cylinder_for_ee_,
                        {1, 0, 0, 1});
    meshcat_->SetObject(c3_actual_ee240_path_ + "/y-axis", cylinder_for_ee_,
                        {0, 1, 0, 1});
    meshcat_->SetObject(c3_actual_ee240_path_ + "/z-axis", cylinder_for_ee_,
                        {0, 0, 1, 1});
  }
  ...
  if (draw_ee_) {
    meshcat_->SetTransform(c3_target_ee0_path_ + "/x-axis",
                           x_axis_transform_ee);
    meshcat_->SetTransform(c3_target_ee0_path_ + "/y-axis",
                           y_axis_transform_ee);
    meshcat_->SetTransform(c3_target_ee0_path_ + "/z-axis",
                           z_axis_transform_ee);
    meshcat_->SetTransform(c3_actual_ee0_path_ + "/x-axis",
                           x_axis_transform_ee);
    meshcat_->SetTransform(c3_actual_ee0_path_ + "/y-axis",
                           y_axis_transform_ee);
    meshcat_->SetTransform(c3_actual_ee0_path_ + "/z-axis",
                           z_axis_transform_ee);
    meshcat_->SetTransform(c3_target_ee120_path_ + "/x-axis",
                           x_axis_transform_ee);
    meshcat_->SetTransform(c3_target_ee120_path_ + "/y-axis",
                           y_axis_transform_ee);
    meshcat_->SetTransform(c3_target_ee120_path_ + "/z-axis",
                           z_axis_transform_ee);
    meshcat_->SetTransform(c3_actual_ee120_path_ + "/x-axis",
                           x_axis_transform_ee);
    meshcat_->SetTransform(c3_actual_ee120_path_ + "/y-axis",
                           y_axis_transform_ee);
    meshcat_->SetTransform(c3_actual_ee120_path_ + "/z-axis",
                           z_axis_transform_ee);
    meshcat_->SetTransform(c3_target_ee240_path_ + "/x-axis",
                           x_axis_transform_ee);
    meshcat_->SetTransform(c3_target_ee240_path_ + "/y-axis",
                           y_axis_transform_ee);
    meshcat_->SetTransform(c3_target_ee240_path_ + "/z-axis",
                           z_axis_transform_ee);
    meshcat_->SetTransform(c3_actual_ee240_path_ + "/x-axis",
                           x_axis_transform_ee);
    meshcat_->SetTransform(c3_actual_ee240_path_ + "/y-axis",
                           y_axis_transform_ee);
    meshcat_->SetTransform(c3_actual_ee240_path_ + "/z-axis",
                           z_axis_transform_ee);
  }
...
drake::systems::EventStatus LcmC3TargetDrawer::DrawC3State(
  ...
  if (draw_tray_) {
    meshcat_->SetTransform(
        ...
        RigidTransformd(
            Eigen::Quaterniond(
                c3_final_target->state[9], c3_final_target->state[10],
                c3_final_target->state[11], c3_final_target->state[12]),
            Vector3d{c3_final_target->state[13], c3_final_target->state[14],
                     c3_final_target->state[15]}),
        context.get_time());
    meshcat_->SetTransform(
        c3_target_object_path_,
        RigidTransformd(
            Eigen::Quaterniond(c3_target->state[9], c3_target->state[10],
                               c3_target->state[11], c3_target->state[12]),
            Vector3d{c3_target->state[13], c3_target->state[14],
                     c3_target->state[15]}),
        context.get_time());
    meshcat_->SetTransform(
        c3_actual_object_path_,
        RigidTransformd(
            Eigen::Quaterniond(c3_actual->state[9], c3_actual->state[10],
                               c3_actual->state[11], c3_actual->state[12]),
            Vector3d{c3_actual->state[13], c3_actual->state[14],
                     c3_actual->state[15]}),
        context.get_time());
  }
  if (draw_ee_) {
    meshcat_->SetTransform(
        ...
        RigidTransformd(Vector3d{c3_target->state[0], c3_target->state[1],
                                 c3_target->state[2]}));
    meshcat_->SetTransform(
        c3_target_ee120_path_,
        RigidTransformd(Vector3d{c3_target->state[3], c3_target->state[4],
                                 c3_target->state[5]}));
    meshcat_->SetTransform(
        c3_target_ee240_path_,
        RigidTransformd(Vector3d{c3_target->state[6], c3_target->state[7],
                                 c3_target->state[8]}));
    meshcat_->SetTransform(
        c3_actual_ee0_path_,
        RigidTransformd(Vector3d{c3_actual->state[0], c3_actual->state[1],
                                 c3_actual->state[2]}));
    meshcat_->SetTransform(
        c3_actual_ee120_path_,
        RigidTransformd(Vector3d{c3_actual->state[3], c3_actual->state[4],
                                 c3_actual->state[5]}));
    meshcat_->SetTransform(
        c3_actual_ee240_path_,
        RigidTransformd(Vector3d{c3_actual->state[6], c3_actual->state[7],
                                 c3_actual->state[8]}));
  }
  return drake::systems::EventStatus::Succeeded();
}
